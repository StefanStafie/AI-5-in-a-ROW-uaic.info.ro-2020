...
class FiveInARow:
    ...
    def new_game(self, adversary_type=1, first_player=1, x_cells=19, y_cells=19, is_swap2=False,
        ...
        self.window = sg.Window('5inaROW', self.layout, element_padding=((0, 0), (0, 0)), margins=(0, 0))
        if is_swap2:
    ...
    def minimax_with_alfabeta_pruning(self, evaluated_matrix, levels, prev_beta, player):
        ...
        :return: a matrix representing the table generated bfy the best move and the position of the move
        """
